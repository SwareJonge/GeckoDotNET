namespace GeckoApp
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label12.Text = "Address protection prevents accessing illegal memory addresses, which will crash the Wii.  However, GameCube mode has a 7F range that can only be accessed by disabling this address protection.";
